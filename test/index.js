...
describe('leader-angellist', function () {
  ...
  it('should wait if theres no company name', function () {
    var context = {}, person = {};
    assert(!angelList.wait(person, context));
  });
  ...
  it('should be able to scrape a angelList company page', function (done) {
  ...
  it('should be able to resolve a valid angelList company profile', function (done) {
    var person = { company: { name: 'segment.io'}};
    var context = {};
    angelList.fn(person, context, function (err) {
